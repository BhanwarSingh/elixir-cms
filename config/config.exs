...
config :contact_management_system, ContactManagementSystemWeb.Auth.Guardian,
  issuer: "contact_management_system",
  secret_key: System.get_env("GUARDIAN_SECRET_KEY") || "TBWABn27KJQAVb8owT2oEOMTWUC7SIhPDks+NS68uvLYB2O09gf3KDTcf2nUvxnu"
